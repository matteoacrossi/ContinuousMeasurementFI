include("src/Eff_QFI_PD_sup.jl")
include("src/Eff_QFI_PD.jl")
...
seed = 2
Random.seed!(seed)
@time t1, fi, qfi = Eff_QFI_PD(Ntraj,# Number of trajectories
    Tfinal,                                  # Final time
    dt,                               # Time step
...
Random.seed!(seed)
@time t2, fi2, qfi2 = Eff_QFI_PD_sup(Ntraj,# Number of trajectories
        Tfinal,                                  # Final time
        dt,                               # Time step
        H, dH,                          # Hamiltonian and its derivative wrt ω
        non_monitored_noise_op,           # Non monitored noise operators
